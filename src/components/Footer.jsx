        ...
        <div className="footer-top">
          ...
          <div className="footer-col-info">
            ...
            <p style={{ whiteSpace: 'nowrap' }}>
              <a href="tel:+51928144703" className="email-link" style={{ color: 'inherit', textDecoration: 'none' }}>+51 928 144 703</a>
              {" / "}
              <a href="tel:+51906093447" className="email-link" style={{ color: 'inherit', textDecoration: 'none' }}>+51 906 093 447</a>
            </p>
